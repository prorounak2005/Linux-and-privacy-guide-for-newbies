...
### Editing softwares
Editing softwares like Adobe doesn't support linux . You can use [bottles](https://usebottles.com/), a frontend to wine to run adobe softwares. It can easily install any .msi ( microsoft installer ) / .exe files. To install bottles follow these steps. Dw it is not that hard :) - 
