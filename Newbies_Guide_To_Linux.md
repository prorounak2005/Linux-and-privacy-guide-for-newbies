...
To install games click on the plus button on the top right corner of lutris ( https://i.imgur.com/cNsDsnI.png ) and then click on `Search lutris website for installers` option. Then type the name of the game you want to install and then press `Enter` key. Click on the game, It will automatically install the game for you. Enjoy !!
